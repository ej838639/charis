...
import FeatImage04 from '../images/ricardo-gomez-angel-j5gCOKZdm6I-unsplash.jpg';
import FeatImage05 from '../images/kristina-flour-BcjdbyKWquw-unsplash.jpg';
import FeatImage06 from '../images/priscilla-du-preez-xM4wUnvbCKk-unsplash.jpg';
          ...
          <div className="grid gap-20">
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-5 lg:col-span-6 mb-8 md:mb-0 rtl" data-aos="fade-up">
                ...
                Photo by <a className="text-green-600 hover:text-green-200 transition duration-150 ease-in-out" href="https://unsplash.com/@rgaleriacom?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Ricardo Gomez Angel</a>
              </div>
              {/* Content */}
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-left">
                <div className="md:pl-4 lg:pl-12 xl:pl-16">
