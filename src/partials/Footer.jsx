...
function Footer() {
  return (
    <footer>
      <div className="bg-black-900 py-12 md:py-16">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              ...
              {/* </div> */}
              <div className="text-gray-400">Charis Mediation. Pursuing peace in relationship with compassion and curiosity.</div>
            </div>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
              ...
              <li className="ml-4">
                <Link to="https://www.instagram.com/charis_mediation/" className="flex justify-center items-center text-purple-600 bg-gray-800 hover:text-gray-100 hover:bg-purple-600 rounded-full transition duration-150 ease-in-out" aria-label="Instagram">
                  <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
              ...
              {/* <li className="ml-4">
                <Link to="https://www.linkedin.com/in/anita-johnson-098ba599/" className="flex justify-center items-center text-purple-600 bg-gray-800 hover:text-gray-100 hover:bg-purple-600 rounded-full transition duration-150 ease-in-out" aria-label="Linkedin">
                  <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">Website built using a design from &copy; <a href="https://cruip.com/">Cruip.com </a></div>
