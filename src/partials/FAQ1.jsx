    ...
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="max-w-3xl mx-auto text-center  pb-12 md:pb-16 pt-32 md:pt-40">
            ...
            <p className="p2">Common questions about mediation</p>
          </div>
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right">
                ...
                <details>
                  <summary className="h4 pb-2 pt-8">My issue involves a lot of emotions. How does mediation handle that?</summary>
                    <div className="pb-8">
                      <p className="p2">Mediation has a structured process that creates an environment to work through difficult emotional issues.</p>
                    </div>
                </details>
                <details>
                  <summary className="h4 pb-2 pt-8">What is the difference among coaching, mediation, and conciliation?</summary>
                    <div className="pb-8">
                      <p className="p2">Coaching involves multipe one-on-one sessions to create a plan to deal with conflict. Mediation facilitates a conversation among parties following a structured process to reach a resolution of substative issues. Conciliation involves a multi-phased process over 3-5 days to help parties reconcile a relationship.</p>
                    </div>
                </details>
                <details>
                ...
                <details>
                  <summary className="h4 pb-2 pt-8">How is counseling different than mediation or coaching?</summary>
                    <div className="pb-8">
                      <p className="p2">Mediators work with two or more people. Counselors work with an individual.</p>
                    </div>
                </details>
                <details>
                  <summary className="h4 pb-2 pt-8">Does Charis Mediation offer arbitration?</summary>
                      <div className="pb-8">
                        <p className="p2">Charis does not offer arbitration. Mediators facilitate a conversation among parties so they can make decisions that are important to them. Arbitrators hear the evidence from both sides and make a binding decision.</p>
                      </div>
                </details>
                <details>
                  <summary className="h4 pb-2 pt-8">What if the person I'm in conflict with is not willing to try mediation?</summary>
                      <div className="pb-8">
                        <p className="p2">A mediation can only be done when both parties have the sincere intention of trying to find a resolution. This includes a willingness to take proposals seriously, make reasonable counter proposals, and make good on their offers.</p>
                      </div>
                </details>
                <details>
