          ...
          <div className="grid gap-20">
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6">
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-5 lg:col-span-6 mb-8 md:mb-0 md:order-1" data-aos="fade-up">
                ...
                Photo by <a className="text-black-900 hover:text-gray-600 transition duration-150 ease-in-out" href="https://unsplash.com/ko/@joshescoto?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Josue Escoto</a>
              </div>
              {/* Text */}
              ...
              <details>
                  <summary className="h4 pb-2 pt-8">Why should I try mediation?</summary>
                    <div className="pb-8">
                      <p className="p2">Mediation is all about win-win. Mediation creates an environment where both parties can be heard and helps them find solutions that work for everyone. Parties who go through mediation have a much better chance of preserving on-going relationships.</p>
                    </div>
                </details>
                <details>
                  <summary className="h4 pb-2 pt-8">What is the difference among coaching, mediation, and a reconciliation process?</summary>
                      <div className="pb-8">
                        <p className="p2">Coaching involves multiple one-on-one sessions to create a plan to deal with conflict. Mediation facilitates a conversation among parties following a structured process to reach a resolution of substantive issues. Reconciliation involves a multi-phased process over 3-5 days to help parties reconcile a relationship.</p>
                      </div>
                </details>
                <details>
                ...
                <details>
                  <summary className="h4 pb-2 pt-8">How is counseling different from mediation or coaching?</summary>
                      <div className="pb-8">
                        <p className="p2">Mediators and coaching walk people through a structured process to help them explore resolution and reconciliation. Mediation and coaching are more focused on exploring possible solutions and ways to reconcile. While mediation and coaching do address past hurts and wrongs it is not the main focus of mediation. Mediation and coaching help create a next step plan or agreement that could involve counseling when appropriate. There is often a clear beginning, middle and end to the coaching and mediation process. Counseling is more focused on healing past hurts and usually is an ongoing process until both the counselor and counselee decide the goals of counseling have been met.</p>
                      </div>
                </details>
                <details>
                ...
                <details>
                  <summary className="h4 pb-2 pt-8">Does Charis Mediation offer arbitration?</summary>
                      <div className="pb-8">
                        <p className="p2">Charis does not offer arbitration. Mediators facilitate a conversation among parties so they can make decisions that are important to them. Arbitrators hear the evidence from both sides and make a binding decision. If you would like a referral to Christian Arbitration let us know in the by clicking “Ask a question” above.</p>
                      </div>
                </details>
                <details>
                ...
                <details>
                  <summary className="h4 pb-2 pt-8">What if the person I'm in conflict with is not willing to try mediation?</summary>
                      <div className="pb-8">
                        <p className="p2">A mediation can only be done when both parties have the sincere intention of trying to find a resolution. This includes a willingness to take proposals seriously, make reasonable counter proposals, and make good on their offers. However at Charis Mediation we believe it is still possible to apply Romans 12:18 and pursue peace as much as it depends on you. We have coaching services available.</p>
                      </div>
                </details>
                <details>
                  <summary className="h4 pb-2 pt-8">What if I am afraid of verbal abuse during the conversation?</summary>
                      <div className="pb-8">
                        <p className="p2">Reconciliation and resolution cannot be accomplished when people are fearful or feel unsafe. At Charis Mediation it is of the utmost importance that all parties feel emotionally and physically safe. At Charis Mediation it is of the utmost importance that all parties feel emotionally and physically safe. From intake to resolution mediators will be checking in with parties to see if they have concerns and feel safe and will address any concerns. We are trained in how to facilitate respectful and productive conversations and how to address it when this doesn't seem to be the case. We will explore what options are available and accommodate. </p>
                      </div>
                </details>
                <details>
                ...
                <details>
                  <summary className="h4 pb-2 pt-8">What if I don’t live in the same area as Charis Mediation, can I still receive help?</summary>
                    <div className="pb-8">
                      <p className="p2">Yes, we can explore either online services or having you covering travel expenses to bring a mediator to your area. We will discuss your needs with you and explore the best options.</p>
                    </div>
                </details>
                <details>
                ...
                <details>
                  <summary className="h4 py-8">Why choose Charis Mediation?</summary>
                      <div className="pb-8">
                        <p className="p2">The lead mediator, Anita, is a certified mediator with over a thousand hours mediating cases. She will give you the space to feel heard, coach you to create a plan, mediate a conflict, or walk you through a conciliation process--whatever you need to reconcile your relationships.</p>
                      </div>
                </details>
              </div>
            </div>
